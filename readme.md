...
- Technical Accuracy – It should follow best practices and reflect the latest ICP standards.
- Uniqueness – The repository must provide original content, avoiding redundancy with existing materials.
- Practical Examples – Preferably includes real-world use cases and hands-on exercises.
Categories
The curated list will be structured into the following categories:
* Courses
...
* Guides
Detailed best practices and documentation for using ICP technologies, helping developers implement specific functionalities.
* Webinars & Workshops
...
- A collection of real-world hackathon challenges for developers to practice and innovate on ICP.
- For each repository included in the curated list, the following details will be provided:
* ICP CDKs: Motoko CDK, Rust CDK.
* Programming Languages: Motoko, Rust, JavaScript, TypeScript.
...
Documentation will be written in English to ensure broader accessibility.
Maintenance & Updates
* The list will undergo a monthly verification process to ensure repositories are still active and up to date.
Outdated resources will be removed or replaced with newer, more relevant content.
The latest versions of ICP CDKs and supported languages will be prioritized to keep the list aligned with ecosystem advancements.
...
- [Code Native Bitcoin](https://youtube.com/playlist?list=PLuhDt1vhGcrcERnmsW-OXGuFRKZsRxYz0&si=Cj6I53-2vx79c2GR) 
